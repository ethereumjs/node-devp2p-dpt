...
DHT.prototype.bind = function(port, address, cb){
...
DHT.prototype.ping = function(peer, cb) {
  ...
  function recFunc(pong, rpeer) {
    ...
    if (pong.hash.toString('hex') !== hash.toString('hex')) {
      ...
      rpeer.udpPort = peer.port;
      rpeer.tcpPort = peer.port;
...
DHT.prototype._pong = function(raw, peer, cb) {
 ...
 */
DHT.prototype.refresh = function(){
  var self = this;
